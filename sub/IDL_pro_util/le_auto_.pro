...
pro LE_AUTO_, x,largeur,nsigma,pm, xnet,para, logfile, $
...
; Processing of edges should be adapted to the trend of the data (flat or not).
...
; (KEYWORDS)
; MEDIAN, EDGE = passed to LIGHTNING => SMOOTHING
; 	EDGE =0 => SMOOTH,/EDGE_TRUNC ; =1 => SMOOTH,/EDGE_WRAP : =2 => custom
